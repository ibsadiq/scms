<!-- pages/student/marked-scripts.vue -->
<template>
  <div class="space-y-6">
    <!-- Page Header -->
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Marked Scripts</h1>
        <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
          View and download your marked examination scripts
        </p>
      </div>
    ...
    <template v-else>
          ...
          <CardContent class="pt-6">
            <div class="flex items-center gap-4">
              <div class="p-3 bg-green-100 dark:bg-green-900/30 rounded-lg">
                <Icon name="lucide:book-open" class="w-6 h-6 text-green-600 dark:text-green-400" />
              </div>
              <div>
          ...
          <CardContent class="pt-6">
            <div class="flex items-center gap-4">
              <div class="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                <Icon name="lucide:calendar" class="w-6 h-6 text-purple-600 dark:text-purple-400" />
              </div>
              <div>
      ...
      <div v-if="filteredScripts.length > 0">
              ...
              <div class="space-y-3">
                <div class="flex items-start justify-between gap-2">
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">{{ script.subject_name }}</p>
                  </div>
                  <Badge variant="secondary">{{ script.classroom_name }}</Badge>
                </div>
        ...
        <Card class="hidden lg:block">
          <CardHeader>
            <CardTitle class="text-lg">Your Marked Scripts ({{ filteredScripts.length }})</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <CardContent class="py-12">
          <div class="text-center text-neutral-500 dark:text-neutral-400">
            ...
            <p class="text-sm mt-2">
              {{ filterExamination || filterSubject ? 'No scripts match your filters' : 'Your teachers haven\'t uploaded any marked scripts yet' }}
            </p>
          </div>
        </CardContent>
      </Card>
