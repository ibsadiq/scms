...
<template>
  <div class="flex h-screen bg-neutral-50 dark:bg-neutral-900 overflow-hidden">
    ...
    >
      ...
      >
        <StudentSidebar @close="isMobileMenuOpen = false" />
      </div>
    </Transition>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex items-center gap-1 flex-shrink-0">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem @click="navigateTo('/student/settings')">
      ...
      <StudentNavbar :title="pageTitle" class="hidden lg:flex" />
...
const pageTitle = computed(() => {
  ...
  if (path.includes('fees')) return 'Fees & Payments'
